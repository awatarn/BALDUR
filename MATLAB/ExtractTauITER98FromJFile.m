function ExtractTauITER98FromJFile(pathOfDirectoryContainingJFile,jFileName,foutput,strFilterPageNo,VariableName)
...
display('ExtractTauITER98FromJFile() is working. ;-)')
...
if exist(tempFile,'file')~=0
    sprintf('%s already exists in %s.\nThe function ExtractTauITER98FromJFile is skipped.',foutput,jFileName)
    return
end
