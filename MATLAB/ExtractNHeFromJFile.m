function ExtractNHeFromJFile(pathOfDirectoryContainingJFile,jFileName,foutput,strFilterPageNo,VariableName)
...
if exist(tempFile,'file')~=0
    sprintf('%s already exists in %s.\nThe function ExtractNHeFromJFile is skipped.',foutput,jFileName)
    return
end
