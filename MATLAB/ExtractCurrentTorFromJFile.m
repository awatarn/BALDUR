function ExtractCurrentTorFromJFile(pathOfDirectoryContainingJFile,jFileName,foutput,strFilterPageNo,VariableName)
...
display('ExtractCurrentTorFromJFile() is working. ;-)')
...
if exist(tempFile,'file')~=0
    sprintf('%s already exists in %s.\nThe function ExtractCurrentTorFromJFile is skipped.',foutput,jFileName)
    return
end
