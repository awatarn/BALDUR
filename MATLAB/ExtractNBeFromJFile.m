function ExtractNBeFromJFile(pathOfDirectoryContainingJFile,jFileName,foutput,strFilterPageNo,VariableName)
...
display('ExtractNBeFromJFile() is working. ;-)')
...
if exist(tempFile,'file')~=0
    sprintf('%s already exists in %s.\nThe function ExtractNBeFromJFile is skipped.',foutput,jFileName)
    return
end
...
%             length(tline0)
%             tline0(87:98)
            NN = str2num(tline0(87:length(tline0)));
        end
    end
